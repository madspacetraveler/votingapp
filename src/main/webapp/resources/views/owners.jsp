    ...
    <table id="myTable" class="table">
        ...
        <c:forEach items="${owners}" var="owner">
            <tr scope="row" class="row-striped border-left border-right border-bottom text-dark">
                <td><a href="/owners/${owner.id}" class="text-dark">${owner.id}</a></td>
                <td><a href="/owners/${owner.id}" class="text-dark">${owner.name} ${owner.surname}</a></td>
                <td><a href="/owners/${owner.id}" class="text-dark">${"-"}</a></td>
                <td><a href="/owners/${owner.id}" class="text-dark">${"-"}</a></td>
            </tr>
        </c:forEach>
