    ...
    <table id="myTable" class="table table-hover">
        ...
        <c:forEach items="${buildings}" var="building">
            <tr scope="row" class="row-striped border-left border-right border-bottom text-dark">
                <td><a href="${pageContext.servletContext.contextPath}/buildings/${building.id}" class="text-dark">${building.id}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/buildings/${building.id}" class="text-dark">${building.adres}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/buildings/${building.id}" class="text-dark">${flats.countFlatsInBuilding(building.id)}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/buildings/${building.id}" class="text-dark">${flats.allFlatsInBuildingArea(building.id)}</a></td>
            </tr>
        </c:forEach>
