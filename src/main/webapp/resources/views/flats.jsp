    ...
    <table id="myTable" class="table table-hover">
        ...
        <c:forEach items="${flats}" var="flat">
            <tr scope="row" class="row-striped border-left border-right border-bottom text-dark">
                <td><a href="${pageContext.servletContext.contextPath}/flats/${flat.id}" class="text-dark">${flat.id}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/flats/${flat.id}" class="text-dark">${flat.building.adres}, m.${flat.flatNumber}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/flats/${flat.id}" class="text-dark">${flat.authorizedVoter.name} ${flat.authorizedVoter.surname}</a></td>
                <td><a href="${pageContext.servletContext.contextPath}/flats/${flat.id}" class="text-dark">${flat.area}</a></td>
            </tr>
        </c:forEach>
